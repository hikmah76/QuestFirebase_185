...
fun InsertMhsView(
    ...
    // Mendeklarasikan state dan event dari ViewModel.
...
fun InsertBodyMhs(
    ...
    Column(
        ...
        FormMahasiswa(
            ...
            errorSate = uiState.isEntryValid,
            modifier = Modifier.fillMaxWidth()
        )
        Button(
            onClick = onClick,
...
fun FormMahasiswa(
    ...
    onValueChange: (MahasiswaEvent) -> Unit,
    errorSate: FormErrorState = FormErrorState(),
    modifier: Modifier = Modifier
){
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text("NIM") },
            isError = errorSate.nim != null,
            placeholder = { Text("Masukkan NIM") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number)
        )
        Text(text = errorSate.nim ?: "", color = Color.Red)
        ...
        OutlinedTextField(
            ...
            label = { Text("Alamat") },
            isError =  errorSate.alamat != null,
            placeholder =  { Text("Masukkan alamat") },
        )
        Text(text = errorSate.alamat ?: "", color = Color.Red)
        ...
        OutlinedTextField(
            ...
            label = { Text("Angkatan") },
            isError = errorSate.angkatan != null,
            placeholder = { Text("Masukkan angkatan") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number)
        )
        Text(text = errorSate.angkatan ?: "", color = Color.Red)
    }
}